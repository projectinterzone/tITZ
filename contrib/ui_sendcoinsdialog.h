...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DASH"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DASH"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DASH"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DASH"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 828, 153));
        ...
        labelBalance->setText(QStringLiteral("123.456 DASH"));
