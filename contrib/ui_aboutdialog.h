...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Interzone Core", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Interzone Core</b> version", 0));
...
"Copyright &copy; 2014-YYYY The Interzone Core developers.", 0));
