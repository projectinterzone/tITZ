...
public:
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        label_4->setText(QApplication::translate("RPCConsole", "Masternode Count", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Interzone debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        ...
        label_41->setText(QApplication::translate("RPCConsole", "Services", 0));
