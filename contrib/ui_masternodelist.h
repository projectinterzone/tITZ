...
public:
    ...
    QCheckBox *cbxAutoStartMissingMNs;
    ...
    void setupUi(QWidget *MasternodeList)
    {
        ...
        cbxAutoStartMissingMNs = new QCheckBox(tabMyMasternodes);
        cbxAutoStartMissingMNs->setObjectName(QStringLiteral("cbxAutoStartMissingMNs"));

        horizontalLayout_5->addWidget(cbxAutoStartMissingMNs);
    ...
    void retranslateUi(QWidget *MasternodeList)
    {
        ...
        cbxAutoStartMissingMNs->setText(QApplication::translate("MasternodeList", "Autostart MISSING", 0));
